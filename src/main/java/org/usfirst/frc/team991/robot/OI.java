...
import org.usfirst.frc.team991.robot.commands.*;
...
public class OI {
	...
	Button g0bA = new JoystickButton(gamepad0, 1);
	Button g0bB = new JoystickButton(gamepad0, 2);
	...
	public OI() 
	{
		button_a.whileHeld(new liftRobot());
		button_b.whileHeld(new lowerRobot());
		button_x.whenPressed(new retractHatchServo());
		button_y.whenPressed(new extendHatchServo());
		g0bA.whileHeld(new driveAxleForward());
		g0bB.whileHeld(new driveAxleBackward());
	}
